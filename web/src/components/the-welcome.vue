  ...
  setup() {
    ...
    const init30DayEcharts = (list: any) => {
      ...
      const option = {
        ...
        series: [{itemStyle : {normal : {color:'#a8bbe1', //改变折线点的颜色
              lineStyle:{color:'#8bcaf8'} //改变折线颜色
            },
          },
            name: '总阅读量',
            type: 'line',
          ...
          {itemStyle : {normal : {color:'#b38fff', //改变折线点的颜色
                lineStyle:{color:'#f6b1da'} //改变折线颜色
              },
            },
            name: '总点赞量',
            type: 'line',
